...
function Page() {
    ...
    const handleVerifiedSubmit = async (token)=>{
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])('/api/auth/reset-password', {
                method: 'POST',
                headers: {
...
_s(Page, "GjyMoXe4QMKQTtL0eXVlRgQ8HBA=", false, function() {
    return [
...
//# sourceMappingURL=_c5abbf48._.js.map
...
"[project]/.next-internal/server/app/api/user-management/logs/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/app/api/auth/[...nextauth]/auth-options.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    providers: [
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$google$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async profile (profile) {
                ...
                const defaultRole = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userRole.findFirst({
                    where: {
                        isDefault: true
                    }
                });
    ...
    callbacks: {
        async jwt ({ token, user, session, trigger }) {
            if (trigger === 'update' && session?.user) {
                ...
                if (user && user.roleId) {
                    const role = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].userRole.findUnique({
                        where: {
                            id: user.roleId
                        }
                    });
...
"[project]/app/api/user-management/logs/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$auth$2d$options$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/api/auth/[...nextauth]/auth-options.ts [app-route] (ecmascript)");
;
;
;
;
async function GET(req) {
    ...
    try {
        const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerSession"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$auth$2f5b2e2e2e$nextauth$5d2f$auth$2d$options$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]);
        if (!session) {
        ...
        const totalCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemLog.count({
            where: {
                AND: [
        ...
        const orderBy = sortField === 'user_name' ? {
            user: {
                name: sortDirection
            }
        } // Sort by user name
        ...
        const logs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].systemLog.findMany({
            where: {
                AND: [
                    ...createdAtFrom || createdAtTo ? [
                        {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__64a775a6._.js.map
...
"[project]/app/(protected)/user-management/settings/components/settings-context.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/app/(protected)/user-management/settings/layout.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const fetchSettings = async ()=>{
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])('/api/user-management/settings');
    if (!response.ok) {
...
function Layout({ children }) {
    ...
    const { data = {
        settings: null,
        roles: []
    }, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'system-settings'
        ],
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$user$2d$management$2f$settings$2f$components$2f$settings$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SettingsProvider"], {
        settings: settings,
        roles: roles,
        children: [
...
_s(Layout, "ueJhyNHSfCCNWe+4M0DWemz8SyI=", false, function() {
    return [
...
//# sourceMappingURL=_f1f21a62._.js.map
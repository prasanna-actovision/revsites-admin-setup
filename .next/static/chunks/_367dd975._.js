...
"[project]/app/(protected)/account/home/settings-plain/components/basic-settings.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const BasicSettings = ({ title })=>{
    ...
    const [addressInput, setAddressInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Avinguda Imaginària, 789');
    const [cityInput, setCityInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Barcelona');
    const [postcodeInput, setPostcodeInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('08012');
...
_s(BasicSettings, "263nf53wRtUyvRvqk/pGo2cx/3k=");
_c = BasicSettings;
;
var _c;
...
"[project]/app/(protected)/account/home/settings-plain/components/password.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/hooks/use-file-upload.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const useFileUpload = (options = {})=>{
    ...
    const [state, setState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        files: initialFiles.map({
            "useFileUpload.useState": (file)=>({
                    file,
                    id: file.id,
                    preview: file.url
                })
        }["useFileUpload.useState"]),
        isDragging: false,
        errors: []
    });
    const inputRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
        ...
        "useFileUpload.useCallback[validateFile]": (file)=>{
            ...
            if (accept !== '*') {
                const acceptedTypes = accept.split(',').map({
                    "useFileUpload.useCallback[validateFile].acceptedTypes": (type)=>type.trim()
                }["useFileUpload.useCallback[validateFile].acceptedTypes"]);
                const fileType = file instanceof File ? file.type || '' : file.type;
                const fileExtension = `.${file instanceof File ? file.name.split('.').pop() : file.name.split('.').pop()}`;
                const isAccepted = acceptedTypes.some({
                    "useFileUpload.useCallback[validateFile].isAccepted": (type)=>{
                        if (type.startsWith('.')) {
                ...
                }["useFileUpload.useCallback[validateFile].isAccepted"]);
                if (!isAccepted) {
    ...
    const createPreview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[createPreview]": (file)=>{
            if (file instanceof File) {
                return URL.createObjectURL(file);
            }
            return file.url;
        }
    }["useFileUpload.useCallback[createPreview]"], []);
    const generateUniqueId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[generateUniqueId]": (file)=>{
            if (file instanceof File) {
                return `${file.name}-${Date.now()}-${Math.random().toString(36).substring(2, 9)}`;
            }
            return file.id;
        }
    }["useFileUpload.useCallback[generateUniqueId]"], []);
    const clearFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[clearFiles]": ()=>{
            setState({
                "useFileUpload.useCallback[clearFiles]": (prev)=>{
                    // Clean up object URLs
                    prev.files.forEach({
                        "useFileUpload.useCallback[clearFiles]": (file)=>{
    ...
    const addFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[addFiles]": (newFiles)=>{
            if (!newFiles || newFiles.length === 0) return;
            const newFilesArray = Array.from(newFiles);
            const errors = [];
            // Clear existing errors when new files are uploaded
            setState({
                "useFileUpload.useCallback[addFiles]": (prev)=>({
                        ...prev,
                        errors: []
                    })
            }["useFileUpload.useCallback[addFiles]"]);
            ...
            const validFiles = [];
            newFilesArray.forEach({
                "useFileUpload.useCallback[addFiles]": (file)=>{
                    // Only check for duplicates if multiple files are allowed
                    if (multiple) {
                        const isDuplicate = state.files.some({
                            "useFileUpload.useCallback[addFiles].isDuplicate": (existingFile)=>existingFile.file.name === file.name && existingFile.file.size === file.size
                        }["useFileUpload.useCallback[addFiles].isDuplicate"]);
    ...
    const removeFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[removeFile]": (id)=>{
            setState({
                "useFileUpload.useCallback[removeFile]": (prev)=>{
                    const fileToRemove = prev.files.find({
                        "useFileUpload.useCallback[removeFile].fileToRemove": (file)=>file.id === id
                    }["useFileUpload.useCallback[removeFile].fileToRemove"]);
                    ...
                    const newFiles = prev.files.filter({
                        "useFileUpload.useCallback[removeFile].newFiles": (file)=>file.id !== id
                    }["useFileUpload.useCallback[removeFile].newFiles"]);
                    onFilesChange?.(newFiles);
                    return {
                        ...prev,
                        files: newFiles,
            ...
            }["useFileUpload.useCallback[removeFile]"]);
        }
    }["useFileUpload.useCallback[removeFile]"], [
        onFilesChange
    ]);
    const clearErrors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[clearErrors]": ()=>{
            setState({
                "useFileUpload.useCallback[clearErrors]": (prev)=>({
                        ...prev,
                        errors: []
                    })
            }["useFileUpload.useCallback[clearErrors]"]);
    ...
    const handleDragEnter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[handleDragEnter]": (e)=>{
            ...
            e.stopPropagation();
            setState({
                "useFileUpload.useCallback[handleDragEnter]": (prev)=>({
                        ...prev,
                        isDragging: true
                    })
    ...
    const handleDragLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[handleDragLeave]": (e)=>{
            ...
            setState({
                "useFileUpload.useCallback[handleDragLeave]": (prev)=>({
                        ...prev,
                        isDragging: false
                    })
    ...
    const handleDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[handleDrop]": (e)=>{
            e.preventDefault();
            e.stopPropagation();
            setState({
                "useFileUpload.useCallback[handleDrop]": (prev)=>({
                        ...prev,
                        isDragging: false
                    })
    ...
    const openFileDialog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[openFileDialog]": ()=>{
            if (inputRef.current) {
                inputRef.current.click();
            }
        }
    ...
    const getInputProps = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFileUpload.useCallback[getInputProps]": (props = {})=>{
            return {
                ...props,
                type: 'file',
    ...
    }["useFileUpload.useCallback[getInputProps]"], [
        accept,
        multiple,
        handleFileChange
    ]);
...
_s(useFileUpload, "DGTasmH8ZfdU4PhxaUcyhXE6vZ0=");
...
"[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$file$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-file-upload.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$spreadsheet$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileSpreadsheetIcon$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/file-spreadsheet.js [app-client] (ecmascript) <export default as FileSpreadsheetIcon>");
...
function FilesUpload({ maxFiles = 5, maxSize = 10 * 1024 * 1024, accept = '*', multiple = true, onFilesChange, simulateUpload = true }) {
    ...
    const defaultImages = [
        {
            ...
            size: 42048,
            type: 'image/png',
            url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAbsoluteUrl"])('/media/avatars/300-1.png')
        },
        {
            id: 'default-4',
            name: 'avatar-4.png',
            size: 62807,
            type: 'image/png',
            url: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toAbsoluteUrl"])('/media/avatars/300-2.png')
        }
    ];
    ...
    const [uploadFiles, setUploadFiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(defaultUploadFiles);
    const [{ isDragging, errors }, { removeFile, clearFiles, handleDragEnter, handleDragLeave, handleDragOver, handleDrop, openFileDialog, getInputProps }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$file$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFileUpload"])({
        maxFiles,
        maxSize,
        accept,
        multiple,
        ...
        onFilesChange: {
            "FilesUpload.useFileUpload": (newFiles)=>{
                // Convert to upload items when files change, preserving existing status
                const newUploadFiles = newFiles.map({
                    "FilesUpload.useFileUpload.newUploadFiles": (file)=>{
                        // Check if this file already exists in uploadFiles
                        const existingFile = uploadFiles.find({
                            "FilesUpload.useFileUpload.newUploadFiles.existingFile": (existing)=>existing.id === file.id
                        }["FilesUpload.useFileUpload.newUploadFiles.existingFile"]);
                        if (existingFile) {
                ...
                }["FilesUpload.useFileUpload.newUploadFiles"]);
                setUploadFiles(newUploadFiles);
                onFilesChange?.(newFiles);
            }
        }["FilesUpload.useFileUpload"]
    });
    // Simulate upload progress
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FilesUpload.useEffect": ()=>{
            if (!simulateUpload) return;
            const interval = setInterval({
                "FilesUpload.useEffect.interval": ()=>{
                    setUploadFiles({
                        "FilesUpload.useEffect.interval": (prev)=>prev.map({
                                "FilesUpload.useEffect.interval": (file)=>{
            ...
            }["FilesUpload.useEffect.interval"], 500);
            return ({
                "FilesUpload.useEffect": ()=>clearInterval(interval)
            })["FilesUpload.useEffect"];
        }
    }["FilesUpload.useEffect"], [
        simulateUpload
    ...
    const getFileIcon = (file)=>{
        ...
        if (type.includes('excel') || type.includes('sheet')) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$file$2d$spreadsheet$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__FileSpreadsheetIcon$3e$__["FileSpreadsheetIcon"], {
            className: "size-4"
        }, void 0, false, {
            fileName: "[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx",
            lineNumber: 206,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('relative rounded-lg border border-dashed p-8 text-center transition-colors', isDragging ? 'border-primary bg-primary/5' : 'border-muted-foreground/25 hover:border-muted-foreground/50'),
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('flex h-16 w-16 items-center justify-center rounded-full', isDragging ? 'bg-primary/10' : 'bg-muted'),
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$upload$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UploadIcon$3e$__["UploadIcon"], {
                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('h-6', isDragging ? 'text-primary' : 'text-muted-foreground')
                                        }, void 0, false, {
                                            fileName: "[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx",
                                            lineNumber: 241,
                                            columnNumber: 8
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: [
                                                    ...
                                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$file$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatBytes"])(maxSize),
                                                    " each"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx",
                    ...
                    uploadFiles.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-3",
                        children: uploadFiles.map((fileItem)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: fileItem.preview && fileItem.file.type.startsWith('image/') ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-xs text-muted-foreground",
                                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$file$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatBytes"])(fileItem.file.size)
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx",
                                                                    lineNumber: 315,
                                                                    columnNumber: 13
                                                ...
                                                fileItem.status === 'uploading' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "mt-2",
                                                ...
                                                fileItem.status === 'error' && fileItem.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertToolbar"], {
                                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    ...
                    errors.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertContent"], {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertTitle"], {
...
_s(FilesUpload, "VSceySSTqMyFTNYFx6xo19Ba2rM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$file$2d$upload$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFileUpload"]
    ];
});
_c = FilesUpload;
var _c;
__turbopack_context__.k.register(_c, "FilesUpload");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/(protected)/account/home/settings-plain/components/index.ts [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({});
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$basic$2d$settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/basic-settings.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$files$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx [app-client] (ecmascript)");
;
;
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/app/(protected)/account/home/settings-plain/components/index.ts [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$password$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/password.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$files$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/index.ts [app-client] (ecmascript) <locals>");
}}),
"[project]/app/(protected)/account/home/settings-plain/content.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/index.ts [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$basic$2d$settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/basic-settings.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$password$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/password.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$files$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/components/files-upload.tsx [app-client] (ecmascript)");
'use client';
...
function AccountSettingsPlainContent() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$basic$2d$settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BasicSettings"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$files$2d$upload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FilesUpload"], {}, void 0, false, {
                fileName: "[project]/app/(protected)/account/home/settings-plain/content.tsx",
                lineNumber: 10,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$components$2f$password$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Password"], {}, void 0, false, {
                fileName: "[project]/app/(protected)/account/home/settings-plain/content.tsx",
                lineNumber: 11,
                columnNumber: 7
            }, this),
...
_c = AccountSettingsPlainContent;
var _c;
__turbopack_context__.k.register(_c, "AccountSettingsPlainContent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
"[project]/app/(protected)/account/home/settings-plain/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$container$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/common/container.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$content$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/(protected)/account/home/settings-plain/content.tsx [app-client] (ecmascript)");
...
function AccountSettingsPlainPage() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$common$2f$container$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Container"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f28$protected$292f$account$2f$home$2f$settings$2d$plain$2f$content$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AccountSettingsPlainContent"], {}, void 0, false, {
                    fileName: "[project]/app/(protected)/account/home/settings-plain/page.tsx",
                    lineNumber: 45,
                    columnNumber: 9
                }, this)
...
_s(AccountSettingsPlainPage, "gxi4fQ+d98hNJYOxevCQ9ERfZgI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$providers$2f$settings$2d$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSettings"]
    ];
});
_c = AccountSettingsPlainPage;
var _c;
__turbopack_context__.k.register(_c, "AccountSettingsPlainPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_367dd975._.js.map